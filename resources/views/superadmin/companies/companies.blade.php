...
<div class="page-header-breadcrumb d-md-flex d-block align-items-center justify-content-between ">
    <h4 class="fw-medium mb-0">Şirketler</h4>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:void(0);" class="text-white-50">Anasayfa</a>
        </li>
        <li class="breadcrumb-item active" aria-current="page">Şirketler</li>
    </ol>
</div>
            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    <div class="card-header">
                        ...
                        <div style="margin-left: auto;" class="card-title"> <a href="{{route('companies.new')}}" class="btn btn-primary">Şirket Oluştur</a></div>
                    </div>
                    <div class="card-body">
                                    ...
                                    <table id="file-export" class="table table-bordered text-nowrap dataTable no-footer" style="width: 100%;" aria-describedby="file-export_info">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" class="sorting" tabindex="0" aria-controls="file-export" rowspan="1" colspan="1" style="width: 169.663px;" aria-label="İsim Soyisim: activate to sort column ascending">Şirket İsmi</th>
                                                <th scope="col" class="sorting sorting_asc" tabindex="0" aria-controls="file-export" rowspan="1" colspan="1" style="width: 94.9375px;" aria-sort="Telefon" aria-label="Telefon: activate to sort column descending">Vergi NO</th>
                                                ...
                                                <th scope="col" class="sorting" tabindex="0" aria-controls="file-export" rowspan="1" colspan="1" style="width: 26.1875px;" aria-label="Kullanıcı Türü: activate to sort column ascending">Telefon</th>
                                                <th scope="col" class="sorting" tabindex="0" aria-controls="file-export" rowspan="1" colspan="1" style="width: 26.1875px;" aria-label="Kullanıcı Durumu: activate to sort column ascending">Oluşturulma Tarihi</th>
                                                <th scope="col" class="sorting" tabindex="0" aria-controls="file-export" rowspan="1" colspan="1" style="width: 169.663px;" aria-label="Şirket: activate to sort column ascending">Durum</th>
                                            ...
                                            <tr class="{{ $counter % 2 == 0 ? 'odd' : 'even' }}">
                                                ...
                                                <td class="text-center">
                                                    <form action="{{ route('companies.destroy', $company->id) }}" method="POST">
                                                        <a href="{{ route('companies.edit', $company->id) }}" class="btn btn-success">Düzenle</a>
