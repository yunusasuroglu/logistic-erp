...
<div class="page-header-breadcrumb d-md-flex d-block align-items-center justify-content-between ">
    <h4 class="fw-medium mb-0">Kelimeler</h4>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:void(0);" class="text-white-50">Diller</a>
        </li>
        <li class="breadcrumb-item active" aria-current="page">Kelimeler</li>
    </ol>
</div>
                ...
                <form method="POST" action="{{ route('languages.translations.update', $language->code) }}">
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">Kelimeleri Güncelle</button>
                            </div>
                        </div>
                        <script>
