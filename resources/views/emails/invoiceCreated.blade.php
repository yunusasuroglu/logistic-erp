...
<head>
	<title>Rechnungsnummer {{$invoice->i_no}}</title>
															...
															<tr>
																<td class="pad" style="width:100%;">
																	<div class="alignment" align="center" style="line-height:10px">
																		<div style="max-width: 650px;"><img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/556/Top.png" style="display: block; height: auto; border: 0; width: 100%;" width="650" alt="Image" title="Image" height="auto"></div>
																	</div>
																</td>
															</tr>
														</table>
								...
								<tr>
									<td>
										<table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000000; background-color: #FFFFFF; width: 650px; margin: 0 auto;" width="650">
											<tbody>
												<tr>
													<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 30px; padding-left: 30px; padding-right: 30px; padding-top: 35px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
														<table class="paragraph_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
															<tr>
																<td class="pad" style="padding-bottom:5px;padding-left:10px;padding-right:10px;padding-top:10px;">
																	<div style="color:#B1AED1;font-family:'Nunito', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:20px;line-height:120%;text-align:center;mso-line-height-alt:24px;">
																		<p style="margin: 0; word-break: break-word;"><span>#{{$invoice->i_no}} Ihre nummerierte Rechnung wurde erstellt</span></p>
																	</div>
																</td>
															</tr>
														</table>
														<table class="paragraph_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
															<tr>
																<td class="pad" style="padding-bottom:5px;padding-left:5px;padding-right:5px;">
																	<div style="color:#454562;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:38px;line-height:120%;text-align:center;mso-line-height-alt:45.6px;">
																		<p style="margin: 0; word-break: break-word;">#{{$invoice->i_no}}</p>
																	</div>
																</td>
															</tr>
														</table>
														<table class="paragraph_block block-3" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
															<tr>
																<td class="pad" style="padding-bottom:10px;padding-left:25px;padding-right:25px;padding-top:10px;">
																	<div style="color:#555555;font-family:'Nunito', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:14px;line-height:150%;text-align:center;mso-line-height-alt:21px;">
																		<p style="margin: 0; word-break: break-word;">Sehr geehrter Kunde,
                                                                            Anbei erhalten Sie Ihre Rechnung #{{$invoice->i_no}} mit der Bitte um Begleichung. <br><br>
                                                                            Vielen Dank für Ihren Auftrag.<br><br>
                                                                            Mit freundlichen Grüßen, <br>
                                                                            {{$invoice->author}} <br> <br>
																			{{$invoice->author_company['name']}} <br>
                                                                            <b>T:</b> {{$invoice->author_company['phone']}} <br>
                                                                            <b>E:</b> {{$invoice->author_company['email']}} <br>
                                                                            Geschäftsführer: {{$invoice->author_company['general_manager']}} <br>
																			<b>A:</b> {{$invoice->author_company['street']}},{{$invoice->author_company['zip_code']}} {{$invoice->author_company['city']}},{{$invoice->author_company['country']}}<br>
                                                                           <b>Steuernummer:</b> {{$invoice->author_company['stnr']}} <br>
                                                                           <b>Umsatsteuer-ID:</b> {{$invoice->author_company['ust_id_nr']}} <br>
                                                                        </p>
																	</div>
																</td>
															</tr>
															...
															<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
																<table class="image_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
																	<tr>
																		<td class="pad" style="width:100%;">
																			<div class="alignment" align="center" style="line-height:10px">
																				<div style="max-width: 650px;"><img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/556/Btm.png" style="display: block; height: auto; border: 0; width: 100%;" width="650" alt="Image" title="Image" height="auto"></div>
																			</div>
																		</td>
																	</tr>
																</table>
