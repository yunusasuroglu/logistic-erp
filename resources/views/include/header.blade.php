                ...
                <div class="header-content-right">
                    ...
                    <div class="offcanvas offcanvas-end wd-330" tabindex="-1" id="apps" aria-labelledby="appsLabel">
                        <div class="offcanvas-header border-bottom">
                            <h5 id="appsLabel" class="mb-0 fs-18">{{ trans_dynamic('header_fast_access') }}</h5>
                                ...
                                <div class="col-6">
                                    <a href="{{ route('profile.edit') }}" class="nav-link">
                                        <div class="text-center p-3 related-app border">
                                            ...
                                            <span class="d-block fs-13 text-muted fw-semibold">{{ trans_dynamic('header_profile') }}</span>
                                        </div>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="header-element mainuserProfile">
                        ...
                        <ul class="dropdown-menu  border-0 main-header-dropdown  overflow-hidden header-profile-dropdown" aria-labelledby="mainHeaderProfile">
                            <li><a class="dropdown-item" href="{{route('profile.edit')}}"><i class="fs-13 me-2 bx bx-user"></i>{{ trans_dynamic('header_profile') }}</a></li>
                            <li><a class="dropdown-item" href="{{route('company.profile')}}"><i class="fs-13 me-2 bx bx-user"></i>{{ trans_dynamic('header_company_profile') }}</a></li>
                            <li><a class="dropdown-item" style="cursor: pointer;" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fs-13 me-2 bx bx-arrow-to-right"></i>{{ trans_dynamic('header_logout') }}</a></li>
